...
public class MainActivity extends AppCompatActivity implements
        ...
        AspectRatioFragment.Listener , EasyPermissions.PermissionCallbacks{
            ...
            getBackgroundHandler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        intent.putExtra("path",cameraPath + timeStamp + ".jpg");
